    ...
    : lang === 'tr'
      ...
      : lang === 'kk'
        ...
        : lang === 'uz'
          ...
          : lang === 'ka'
            ? 'Write natural modern Georgian (Mkhedruli script). Use the formal «თქვენ» form when addressing the user. Use «მენსტრუაცია» for period, «ბავშვი» for baby, «ჯანმო» for WHO. Emergency number is 112.'
            : lang === 'de'
