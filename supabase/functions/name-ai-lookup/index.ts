...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const displayLang = ['az', 'en', 'ru', 'tr', 'kk', 'uz', 'de', 'ar'].includes(language) ? language : 'az';
    ...
    if (existing) {
      ...
      return new Response(JSON.stringify({
        ...
        display: {
          ...
          meaning: existing[f.meaning] || (displayLang === 'kk' || displayLang === 'uz' ? existing.meaning_ru : null) || (displayLang === 'de' || displayLang === 'ar' ? existing.meaning_en : null) || existing.meaning_az || existing.meaning,
          origin: existing[f.origin] || (displayLang === 'kk' || displayLang === 'uz' ? existing.origin_ru : null) || (displayLang === 'de' || displayLang === 'ar' ? existing.origin_en : null) || existing.origin,
...
{"found":true,"gender":"girl","origin_az":"Ərəb mənşəli","origin_en":"Arabic","origin_ru":"Арабское","origin_tr":"Arapça kökenli","origin_kk":"Араб тілінен","origin_uz":"Arab tilidan","origin_de":"Arabischer Herkunft","origin_ar":"من أصل عربي","meaning_az":"...","meaning_en":"...","meaning_ru":"...","meaning_tr":"...","meaning_kk":"...","meaning_uz":"...","meaning_de":"...","meaning_ar":"..."}
2. gender: "boy" | "girl" | "unisex"
3. Hər meaning_* qısa və dəqiq olsun (maksimum 120 simvol), həmin dildə yazılsın (meaning_kk qazax dilində kiril, meaning_uz özbək dilində latın yazısı, meaning_de alman, meaning_ar ərəb dilində).
