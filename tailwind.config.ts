  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        // Anacan custom colors - Life Stages
        flow: {
          DEFAULT: "hsl(var(--flow))",
          light: "hsl(var(--flow-light))",
          dark: "hsl(var(--flow-dark))",
        },
        bump: {
          DEFAULT: "hsl(var(--bump))",
          light: "hsl(var(--bump-light))",
          dark: "hsl(var(--bump-dark))",
        },
        mommy: {
          DEFAULT: "hsl(var(--mommy))",
          light: "hsl(var(--mommy-light))",
          dark: "hsl(var(--mommy-dark))",
        },
        partner: {
