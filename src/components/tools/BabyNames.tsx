                  ...
                  return (
                    <>
                      ...
                      <div className="flex items-center justify-center gap-2">
                        ...
                        <span className="a-cta-badge" style={{ background: 'var(--a-chip-overlay)', color: ink, padding: '4px 10px', fontSize: 10 }}>
                          {selectedName.origin || (language === 'en' ? 'Azerbaijan' : language === 'tr' ? 'Türkçe' : language === 'ru' ? 'Русское' : language === 'kk' ? 'Әзербайжан' : language === 'de' ? 'International' : tr("babynames_azerbaycan_733e93", "Az\u0259rbaycan"))}
                        </span>
                      </div>
                    </>);
                })()}
