...
export default function VaccineCalendar({ onBack }: Props) {
  ...
  // Uşaq üçün ölkə seçilməyibsə, default tətbiq dilinə görə (tr→TR, ru→RU, kk→KZ, de→DE, əks halda AZ)
  const langDefaultCountry = lang === 'tr' ? 'TR' : lang === 'ru' ? 'RU' : lang === 'kk' ? 'KZ' : lang === 'de' ? 'DE' : 'AZ';
