...
const noiseTypes = [
  { 
    id: 'white', label: t("whitenoise_beyaz_kuy_3acf2d", 'Bəyaz Küy'), subtitle: 'Sakitləşdirici',
    description: t("whitenoise_ana_betnindeki_sese_benzer_monoton_fon_8d1144", 'Ana bətnindəki səsə bənzər monoton fon'), emoji: '⚪',
  ...
  { 
    id: 'pink', label: t("whitenoise_cehrayi_kuy_68573d", 'Çəhrayı Küy'), subtitle: 'Təbiət effekti',
    description: t("whitenoise_yungul_yagis_ve_yarpaq_xisiltisi_kimi_d5aea8", 'Yüngül yağış və yarpaq xışıltısı kimi'), emoji: '🌸',
  ...
  { 
    id: 'brown', label: t("whitenoise_qehveyi_kuy_f8e3c6", 'Qəhvəyi Küy'), subtitle: 'Dərin yuxu',
    description: t("whitenoise_derin_ve_boguq_sesler_selale_goy_gurultu_47382e", 'Dərin və boğuq səslər — şəlalə, göy gurultusu'), emoji: '🟤',
...
const WhiteNoise = forwardRef<HTMLDivElement, WhiteNoiseProps>(function WhiteNoiseComponent({ onBack }, ref) {
  ...
  const timerOptions = isPremium 
    ? [
        ...
        { value: 15, label: t("whitenoise_15_deq_3ce4c1", '15 dəq'), icon: '15' },
        { value: 30, label: t("whitenoise_30_deq_15eb1f", '30 dəq'), icon: '30' },
        { value: 60, label: '1 saat', icon: '60' },
      ]
    : [
        { value: 10, label: t("whitenoise_10_deq_b4f9fd", '10 dəq'), icon: '10' },
        { value: 15, label: t("whitenoise_15_deq_3ce4c1", '15 dəq'), icon: '15' },
        { value: 20, label: t("whitenoise_20_deq_fb3505", '20 dəq'), icon: '20' },
      ];
