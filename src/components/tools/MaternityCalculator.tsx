...
const MaternityCalculator = ({ onBack }: MaternityCalculatorProps) => {
  ...
  const pregnancyTypes = [
    { 
      value: 'normal', 
      label: t("maternitycalculator_normal_hamilelik_fa223b", 'Normal hamiləlik'), 
      description: t("maternitycalculator_126_gun_70_56_9d7bc1", '126 gün (70+56)'),
      icon: '👶'
    },
    { 
      value: 'complicated', 
      label: t("maternitycalculator_agir_dogus_3e1a6b", 'Ağır doğuş'), 
      description: t("maternitycalculator_140_gun_70_70_197a87", '140 gün (70+70)'),
      icon: '🏥'
    },
    { 
      value: 'multiple', 
      label: t("maternitycalculator_coxdollu_hamilelik_e3c1aa", 'Çoxdöllü hamiləlik'), 
      description: t("maternitycalculator_194_gun_84_110_52cf0f", '194 gün (84+110)'),
      icon: '👶👶'
    },
  ];
            ...
            >
              ...
              <div className="relative">
                <Input
                  ...
                  placeholder={t("maternitycalculator_meselen_800_4effcf", "Məsələn: 800")}
