...
import {
  ...
  Award, Loader2, Dumbbell, Sparkles, Play, Trophy } from
'lucide-react';
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1">
              <h1 className="text-lg font-bold text-foreground flex items-center gap-2">
                ...
                {selectedExercise ? selectedExercise.name : tr("exercises_hamile_mesqleri_139b99", "Hamil\u0259 M\u0259\u015Fql\u0259ri")}
              </h1>
              <p className="text-xs text-muted-foreground">{currentTrimester}{tr("exercises_trimester_ucun_a94dca", ". trimester \xFC\xE7\xFCn")}</p>
            </div>
          </div>
        </div>
      </div>
