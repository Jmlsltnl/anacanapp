...
const genderOptions = [
  { value: 'boy', label: t("childselector_oglan_e9715e", 'Oğlan'), emoji: '👦' },
  { value: 'girl', label: t("childselector_qiz_79bf6b", 'Qız'), emoji: '👧' },
];
        ...
        <div className="space-y-4">
          <div>
            ...
            <Input
              ...
              placeholder={t("childselector_korpenin_adi_8a4e9e", "Körpənin adı")}
            />
          </div>
          <div>
