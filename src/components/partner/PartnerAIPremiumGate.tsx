      ...
      >
        <div className="flex flex-col items-center text-center mb-8">
          ...
          <h1 className="text-2xl font-black text-foreground mb-2">
            Anacan.AI Premium üçündür
          </h1>
          <p className="text-muted-foreground text-sm leading-relaxed">
            Anacan.AI köməkçisi və partnyor funksiyaları yalnız Premium istifadəçilər üçündür.
            Həyat yoldaşınızın və ya öz hesabınızın Premium aboneliyi aktiv olduqda burada
        ...
        <div className="bg-card rounded-3xl p-5 border border-border/50 shadow-card mb-5">
          ...
          <ul className="space-y-2.5">
            {[
              'Anacan.AI ilə limitsiz söhbət',
              'Hamiləlik və körpə bilgiləri',
              'Partnyor mod və sinxronizasiya',
              'Bütün premium alətlər',
            ].map((item) => (
        ...
        <p className="text-center text-xs text-muted-foreground mt-3">
          Aboneliyi həyat yoldaşınız da əldə edə bilər — ikiniz üçün də açılacaq.
        </p>
      </motion.div>
