      ...
      <div className="flex items-center gap-3">
        ...
        <div className="flex-1">
          ...
          <p className="text-xs text-muted-foreground">
            {alreadySent ? tr("senddailysummarywidget_bugunku_xulase_gonderildi_5c9ee2", "Bug\xFCnk\xFC x\xFClas\u0259 g\xF6nd\u0259rildi \u2713") : tr("senddailysummarywidget_partnyorunuza_bugunku_veziyyet_d67b2b", "Partnyorunuza bug\xFCnk\xFC v\u0259ziyy\u0259tinizi g\xF6nd\u0259rin")
        ...
        <div className="flex items-center gap-1.5">
          ...
          <Button
            ...
            <>
                ...
                {tr("senddailysummarywidget_yeniden_725ab4", "Yenid\u0259n")}
              </> :

            <>
                <Send className="w-4 h-4 mr-1" />
                {tr("senddailysummarywidget_gonder_3f11bd", "G\xF6nd\u0259r")}
              </>
            }
          </Button>
        </div>
