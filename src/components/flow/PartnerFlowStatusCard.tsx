...
const PHASE_INFO: Record<string, {label: string;emoji: string;tip: string;color: string;}> = {
  menstrual: { label: 'Menstruasiya', emoji: '🩸', tip: tr("partnerflowstatuscard_yumsaq_ol_isti_cay_teklif_et_e_bb3d00", "Yum\u015Faq ol, isti \xE7ay t\u0259klif et, ev i\u015Fl\u0259rind\u0259 k\xF6m\u0259k et."), color: 'from-rose-500 to-red-500' },
  follicular: { label: 'Follikular', emoji: '🌱', tip: tr("partnerflowstatuscard_enerjisi_yuksekdir_birlikde_ak_59c2fd", "Enerjisi y\xFCks\u0259kdir \u2014 birlikd\u0259 aktiv vaxt ke\xE7irin."), color: 'from-emerald-500 to-teal-500' },
  ovulation: { label: 'Ovulyasiya', emoji: '🌸', tip: tr("partnerflowstatuscard_fertil_dovrdur_yaxinliga_diqqe_610fc2", "Fertil d\xF6vrd\xFCr. Yax\u0131nl\u0131\u011Fa diqq\u0259t g\xF6st\u0259r."), color: 'from-pink-500 to-fuchsia-500' },
  luteal: { label: 'Lutein (PMS)', emoji: '🌙', tip: tr("partnerflowstatuscard_sebirli_ol_menfi_reaksiyalari__ed5047", "S\u0259birli ol, m\u0259nfi reaksiyalar\u0131 \u015F\u0259xsi q\u0259bul etm\u0259."), color: 'from-indigo-500 to-purple-500' }
};
