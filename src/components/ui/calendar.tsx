...
function Calendar({ className, classNames, showOutsideDays = true, locale, ...props }: CalendarProps) {
  return (
    <DayPicker
      ...
      locale={locale || getCurrentDateLocale()}
      classNames={{
      ...
      components={{
        IconLeft: ({ ..._props }) => <ChevronLeft className="rtl:rotate-180 h-4 w-4" />,
        IconRight: ({ ..._props }) => <ChevronRight className="rtl:rotate-180 h-4 w-4" />,
      }}
      {...props}
    />
  );
