...
export default function AdminPartnerRedemptions() {
  ...
  return (
    <div className="p-4 space-y-4">
      <h1 className="text-2xl font-bold flex items-center gap-2"><Sparkles className="w-5 h-5 text-primary" /> Endirim Hesabatı</h1>

      <div className="grid grid-cols-3 gap-3">
        <Card className="p-4"><p className="text-xs text-muted-foreground">Bu gün</p><p className="text-2xl font-bold">{stats.today}</p></Card>
        <Card className="p-4"><p className="text-xs text-muted-foreground">Bu həftə</p><p className="text-2xl font-bold">{stats.week}</p></Card>
        ...
        <table className="w-full text-sm">
          <thead className="bg-muted">
            <tr>
              ...
              <th className="p-2 text-left">Məkan</th>
              <th className="p-2 text-left">İstifadəçi</th>
              <th className="p-2 text-left">Yaradılıb</th>
              <th className="p-2 text-left">Təsdiqlənib</th>
