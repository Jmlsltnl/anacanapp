...
import { Mail, Lock, User, ArrowRight, Heart, Users } from 'lucide-react';
...
const AuthScreen = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background safe-top safe-bottom">
      {/* Header */}
      <div className="gradient-primary pt-12 pb-20 px-6 rounded-b-[3rem]">
        <motion.div
        ...
        >
          <div className="w-16 h-16 rounded-full bg-white/20 backdrop-blur-sm flex items-center justify-center mb-4">
            <Heart className="w-8 h-8 text-white fill-white/30" strokeWidth={1.5} />
          </div>
          <h1 className="text-3xl font-bold text-white">Anacan</h1>
          <p className="text-white/80 mt-1">Bədəninlə harmoniyada ol</p>
        </motion.div>
      </div>
            ...
            >
                  ...
                  <motion.div variants={itemVariants}>
                    <div className="relative">
                      ...
                      <Input
                        ...
                        className="pl-12 h-14 rounded-2xl bg-muted border-0 text-base uppercase tracking-wider"
                      />
                    </div>
                  </motion.div>
                </>
              ...
              <motion.div variants={itemVariants}>
                <Button
                  type="submit"
                  disabled={isLoading}
                  className="w-full h-14 rounded-2xl gradient-primary text-white font-semibold text-base shadow-button hover:opacity-90 transition-opacity"
                >
                  {isLoading ? (
                    <motion.div
