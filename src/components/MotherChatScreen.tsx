...
const MotherChatScreen = ({ onBack }: MotherChatScreenProps) => {
  ...
  const sendMessage = async () => {
    ...
    try {
      ...
      toast({
        title: t("motherchatscreen_xeta_3cdbb6", 'Xəta'),
        description: t("motherchatscreen_mesaj_gonderile_bilmedi_0cd095", 'Mesaj göndərilə bilmədi'),
        variant: 'destructive',
      });
    }
  };
      ...
      <div className="p-4 bg-card border-t border-border safe-bottom">
        <div className="flex items-center gap-2">
          ...
          <input
            ...
            placeholder={t("motherchatscreen_mesaj_yazin_e69f84", "Mesaj yazın...")}
